  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.logoWrap}>
          ...
          >
            <View style={styles.logoCircle}>
              <Image source={appIcon} style={styles.logoInner} resizeMode="cover" />
            </View>
          </Animated.View>
        </View>
        ...
        >
          <Text style={styles.brandName}>Smatt</Text>
          <Text style={styles.brandSub}>Smart Attendance System</Text>
        </Animated.View>

        {/* Bouncing dots */}
        <Animated.View style={[styles.loader, { opacity: dotsOpacity }]}>
          <Animated.View style={[styles.dot, { backgroundColor: '#4F6EF7', transform: [{ translateY: dot1Y }] }]} />
          <Animated.View style={[styles.dot, { backgroundColor: '#7B95FF', transform: [{ translateY: dot2Y }] }]} />
          <Animated.View style={[styles.dot, { backgroundColor: '#a78bfa', transform: [{ translateY: dot3Y }] }]} />
        </Animated.View>
      </View>
