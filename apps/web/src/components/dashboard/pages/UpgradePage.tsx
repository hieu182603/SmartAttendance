    ...
    <div className="relative min-h-screen -mx-4 -mt-4 sm:-mx-6 sm:-mt-6" style={gridBgStyle}>
      ...
      {screen === "pricing" && (
        <div className="min-h-screen flex flex-col">
          ...
          {/* Header */}
          <header className="sticky top-0 z-50 flex items-center justify-between px-6 sm:px-10 h-14
            bg-[var(--background)]/90 backdrop-blur-md border-b border-[var(--border)]">
            <span className="flex items-center gap-2.5 font-bold text-[var(--text-main)] text-base">
              <span className="w-8 h-8 rounded-lg flex items-center justify-center text-sm font-extrabold text-white
                bg-gradient-to-br from-blue-700 to-sky-600 shadow">S</span>
              Smart<em className="not-italic text-[var(--accent-cyan)]">Attendance</em>
            </span>
            <span className="hidden sm:inline-flex font-mono text-[10px] font-medium tracking-widest text-[var(--accent-cyan)]
              border border-[var(--accent-cyan)]/20 bg-[var(--accent-cyan)]/5 px-3.5 py-1 rounded-full">
              {t("dashboard:upgrade.checkout.pricingHeader")}
            </span>
          </header>
