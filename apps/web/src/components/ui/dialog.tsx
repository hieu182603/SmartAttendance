    ...
    return (
      <>
        ...
        <div
          ref={ref}
          className={cn(
            'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-[var(--border)] rounded-2xl bg-[var(--surface)] p-6 text-[var(--text-main)] shadow-2xl duration-200',
            className
          )}
          {...props}
        >
