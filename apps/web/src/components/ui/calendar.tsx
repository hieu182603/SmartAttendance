  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[var(--primary)] text-white font-semibold shadow-md shadow-[var(--primary)]/30 border-none outline-none ring-0 hover:bg-[var(--primary)] hover:text-white focus:bg-[var(--primary)] focus:text-white",
        day_today: "text-[var(--primary)] font-bold bg-[var(--primary)]/10",
        day_outside:
