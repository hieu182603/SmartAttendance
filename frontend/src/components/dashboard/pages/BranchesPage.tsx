      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="bg-[var(--surface)] border-[var(--border)] text-[var(--text-main)] max-w-6xl">
          ...
          {selectedBranch && (
            <div className="space-y-6">
              {/* Header */}
              <div className="flex items-start justify-between p-6 rounded-lg bg-gradient-to-r from-[var(--primary)]/10 to-[var(--accent-cyan)]/10 border border-[var(--primary)]/30">
                <div className="flex items-center space-x-4">
                  <div className="h-20 w-20 rounded-xl bg-gradient-to-r from-[var(--primary)] to-[var(--accent-cyan)] flex items-center justify-center">
                    <Building2 className="h-10 w-10 text-white" />
                  </div>
                  <div>
                    <h3 className="text-2xl text-[var(--text-main)]">{selectedBranch.name}</h3>
                    <p className="text-sm text-[var(--text-sub)] mt-1">Mã: {selectedBranch.code}</p>
                    <Badge className={`mt-2 ${selectedBranch.status === 'active'
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="text-lg text-[var(--text-main)] flex items-center gap-2">
                    <MapPin className="h-5 w-5 text-[var(--primary)]" />
                    Thông tin liên hệ
                  </h4>

                  <div className="space-y-3">
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-[var(--shell)]">
                      <MapPin className="h-5 w-5 text-[var(--accent-cyan)] mt-0.5" />
                      <div>
                        <p className="text-sm text-[var(--text-sub)]">Địa chỉ</p>
                        <p className="text-[var(--text-main)]">{selectedBranch.address}</p>
                        <p className="text-[var(--text-main)]">{selectedBranch.city}, {selectedBranch.country}</p>
                      </div>
                    </div>

                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-[var(--shell)]">
                      <Phone className="h-5 w-5 text-[var(--accent-cyan)] mt-0.5" />
                      <div>
                        <p className="text-sm text-[var(--text-sub)]">Số điện thoại</p>
                        <p className="text-[var(--text-main)]">{selectedBranch.phone}</p>
                      </div>
                    </div>

                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-[var(--shell)]">
                      <Mail className="h-5 w-5 text-[var(--accent-cyan)] mt-0.5" />
                      <div>
                        <p className="text-sm text-[var(--text-sub)]">Email</p>
                        <p className="text-[var(--text-main)]">{selectedBranch.email}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-[var(--shell)]">
                      <TrendingUp className="h-5 w-5 text-[var(--warning)] mt-0.5" />
                      <div>
                    ...
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-[var(--shell)]">
                      <Building2 className="h-5 w-5 text-[var(--primary)] mt-0.5" />
                      <div>
                        <p className="text-sm text-[var(--text-sub)]">Loại chi nhánh</p>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-[var(--primary)]/10 to-[var(--accent-cyan)]/10 border border-[var(--primary)]/30">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-[var(--text-main)]">Hiệu suất hoạt động</p>
