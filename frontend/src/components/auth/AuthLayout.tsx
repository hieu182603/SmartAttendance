      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            transition={{ delay: 0.5 }}
          >
            Hệ thống chấm công thông minh với ảnh, GPS và nhận diện khuôn mặt
          </motion.p>
          ...
          >
            {[
              { icon: Camera, label: "Chấm công ", delay: 0.1, color: "from-cyan-400 via-cyan-500 to-blue-500", bgColor: "bg-cyan-500/20" },
