...
requestRouter.post('/bulk-approve', requireRole([ROLES.ADMIN, ROLES.HR_MANAGER, ROLES.MANAGER, ROLES.SUPER_ADMIN]), bulkApproveRequests)
requestRouter.post('/bulk-reject', requireRole([ROLES.ADMIN, ROLES.HR_MANAGER, ROLES.MANAGER, ROLES.SUPER_ADMIN]), bulkRejectRequests)
